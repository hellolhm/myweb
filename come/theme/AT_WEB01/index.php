...
<div class="bannerWrap">
    <img src="/img/mainbr.png">
    <div>
        <h2 class="wow fadeInDown" data-wow-delay="0.3s">승리를 향한 열정</h2>
        <p class="wow fadeInDown" data-wow-delay="0.6s">당신의 완벽한 승리를 커세어가 함께합니다.</span></p>
